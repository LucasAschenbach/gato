"""
Acknowledgement:
These configurations were taken from OrigamiDream's gato tensorflow implementation.
Original Source: https://github.com/OrigamiDream/gato/blob/main/gato/config.py
"""
